...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
      <div class="btn-group me-2">
        <a href="{{route('admin.slideMobils.create')}}" class="btn btn-sm btn-outline-secondary">Добавить новую</a>
      </div>
      {{-- <div class="btn-group me-2">
      ...
      <div class="table-responsive">
        ...
        <table class="table table-striped table-sm">
                 ...
                 <tr>
                  ...
                  <td>
                   ...
                   <td>
                    ...
                    <td>
                      <a href="{{route('admin.slideMobils.edit', ['slideMobil' => $slide->id ])}}" class="btn btn-primary">Ред.</a>
                      {{-- &nbsp;|&nbsp; --}}
          ...
          {{-- {{dd($slide->id)}} --}}
                      ...
                      <form  action="{{ route('admin.slideMobils.destroy' , ['slideMobil' => $slide->id ])}}" method="POST">
                        {{ csrf_field() }}           
