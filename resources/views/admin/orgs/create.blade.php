...
@section('title') Добавить новое юридическое лицо - @parent @stop
@section('content')

<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Добавить новое юридическое лицо </h1>
  ...
  <div style="width: 45%;height: 400px;">
    <img id="upload1" style="width: 100%" src="" alt="">
      ...
      <div class="table-responsive">
        @include('inc.message')
        <form  method="post" action="{{route('admin.orgs.store')}}" enctype="multipart/form-data">
          @csrf 
            ...
            <div class="form-group">
              ...
              <input type="text" style="margin: 4px;width:98%;" class="form-control" name="office" id="office" required>
            </div>
            <div class="form-group">
