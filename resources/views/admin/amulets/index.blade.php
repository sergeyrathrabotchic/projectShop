...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
      <div class="btn-group me-2">
        <a href="{{route('admin.amulets.create')}}" class="btn btn-sm btn-outline-secondary">Добавить новый товар</a>
      </div>
      {{-- <div class="btn-group me-2">
          ...
          <tbody>
            ...
            @forelse ($ceramics as $ceramic)
                 ...
                 <tr>
                  ...
                  {{-- {{dd($ceramic)}} --}}
                  <td>
                    <img src="{{Storage::disk('image')->url($ceramic->productImage->where('type', 'amulet')->values()->reverse()[0]->image)}}" alt="" style="width: 80%;padding: 10px;"></td>
                  <td>
