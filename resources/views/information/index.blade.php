        ...
        <div class="offcanvas offcanvas-end" style="background-color: #f6f0ee !important;" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{route('electroplatings')}}">Медные украшениУкрашения из Меди и<br> Смолыдные украшения</a>
              </li> --}}
          ...
          <h5 class="card-title">
            ...
            <div  style="display: flex;justify-content: space-between;font-size: 26px;margin-top: -37px;">
              <div style="font-size: 27px;"></div><div style="display: flex;flex-direction: column;align-items: flex-end;font: 12px ProximaNova-Light,sans-serif;">
                ...
                <div id="shareLink{{$k}}" style="color: rgb(246, 240, 238); border: 1px solid rgb(220, 177, 139);background-color: rgb(220, 177, 139);border-radius: 5px;font-family: 'Open Sans';font-weight: 400;margin-right: 0px;font-size: 15px;padding: 12px;width: 100px;text-align: center;cursor: pointer;">Связаться</div>
