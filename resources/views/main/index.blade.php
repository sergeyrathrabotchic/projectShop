      ...
      <div class="container-fluid">
        <div>
          <div style="display: flex;justify-content: center;">
            <a   href="https://wa.me/79631450453" target="_blank" style="text-decoration: none;color: black;display: flex;">
              <img style="width: 30px;height: 30px;margin-right: 5px;padding: 5px" alt="Logo" src="/assets/media/staticImages/whatsapp2.png" >
            </a>
            <a   href="https://wa.me/79631450453" target="_blank" style="text-decoration: none;color: black;display: flex;">
              <img style="width: 25px;height: 25px;margin-right: 5px;padding: 10px;" alt="Logo" src="/assets/media/staticImages/vk.png" >
            </a>
          </div>
        </div>
